...
var ln = Me((fn, zr2) => {
  (function(e6) {
    ...
    return a(function n(o, i, s6) {
      ...
      a(u, "s");
      for (var c = typeof Ee == "function" && Ee, p = 0; p < s6.length; p++)
        u(s6[p]);
      return u;
    }, "e")({ 1: [function(n, o, i) {
...
var Qo = M2((ep, cs) => {
  (function(e6) {
    ...
    return a2(function n(o, i, l) {
      ...
      a2(u, "s");
      for (var c = typeof Xo == "function" && Xo, d = 0; d < l.length; d++)
        u(l[d]);
      return u;
    }, "e")({ 1: [function(n, o, i) {
...
function ks(e6) {
  if (typeof Symbol < "u" && e6[Symbol.iterator] != null || e6["@@iterator"] != null)
...
function Ts(e6, t) {
  if (e6) {
    ...
    if (r === "Object" && e6.constructor && (r = e6.constructor.name), r === "Map" || r === "Set")
      return Array.from(e6);
...
function Eh(e6, t) {
  var r;
  if (e6.type === "text" || e6.type === "comment" || zi(e6) || e6.type === "yaml" || e6.type === "toml")
    return null;
  if (e6.type === "attribute" && delete t.value, e6.type === "docType" && delete t.value, e6.type === "angularControlFlowBlock" && (r = t.parameters) != null && r.children)
    for (let n of t.parameters.children)
      dx.has(e6.name) ? delete n.expression : n.expression = n.expression.trim();
...
function wx(e6, t) {
  if (t)
    return e6.find(({ name: r }) => r.toLowerCase() === t) ?? e6.find(({ aliases: r }) => r == null ? void 0 : r.includes(t)) ?? e6.find(({ extensions: r }) => r == null ? void 0 : r.includes(`.${t}`));
}
function yx(e6, t) {
...
function Lx(e6, t) {
  var r, n;
  let o = i();
  if (o && !e6.prev && (n = (r = e6.parent) == null ? void 0 : r.tagDefinition) != null && n.ignoreFirstLf)
    return e6.type === "interpolation";
  return o;
  function i() {
  ...
  if (e6)
    switch (e6) {
      ...
      case "text/x-handlebars-template":
        return "glimmer";
      default:
        if (e6.endsWith("json") || e6.endsWith("importmap") || e6 === "speculationrules")
          return "json";
    }
}
function Hx(e6, t) {
...
function Ux(e6, t) {
  ...
  let n = false;
  if (e6.type === "element" && e6.namespace === "svg")
    if (Wx(e6, (o) => o.fullName === "svg:foreignObject"))
      n = true;
    else
      return e6.name === "svg" ? "inline-block" : "block";
...
async function Zx(e6, t) {
  let r = [];
  for (let [n, o] of e6.split(zh).entries())
    if (n % 2 === 0)
      r.push(lt2(o));
    else
      try {
...
function tC(e6, t) {
  ...
  let o = er2(r);
  if (/^i18n(?:-.+)?$/.test(n))
    return () => Oi(Ch(Hh(r, o.trim())), !o.includes("@@"));
  if (zh.test(o))
    return (i) => Zx(o, i);
}
function nC(e6, t) {
...
function cC(e6) {
  ...
  function h() {
    for (d(aC), o = "", i = "in descriptor"; ; ) {
      if (l = e6.charAt(u), i === "in descriptor")
        if (q5(l))
        ...
        if (l === ")")
          ...
          o += l;
      else if (i === "after descriptor" && !q5(l))
        if (l === "") {
          f();
          return;
        } else
  ...
  function f() {
    ...
    for (y = 0; y < n.length; y++)
      D4 = n[y], x = D4[D4.length - 1], C = D4.substring(0, D4.length - 1), E = parseInt(C, 10), S6 = parseFloat(C), W5.test(C) && x === "w" ? ((w4 || m) && (g6 = true), E === 0 ? g6 = true : w4 = E) : uC.test(C) && x === "x" ? ((w4 || m || v) && (g6 = true), S6 < 0 ? g6 = true : m = S6) : W5.test(C) && x === "h" ? ((v || m) && (g6 = true), E === 0 ? g6 = true : v = E) : g6 = true;
    if (!g6)
      b.source = { value: r, startOffset: c }, w4 && (b.width = { value: w4 }), m && (b.density = { value: m }), v && (b.height = { value: v }), p.push(b);
    else
      throw new Error(`Invalid srcset descriptor found in "${e6}" at "${D4}".`);
  }
  a2(f, "g");
}
function dC(e6) {
  if (e6.node.fullName === "srcset" && (e6.parent.fullName === "img" || e6.parent.fullName === "source"))
    return () => hC(er2(e6.node));
}
function hC(e6) {
...
function gC(e6, t) {
  ...
  if (r.fullName === "style" && !t.parentParser && !n.includes("{{"))
    return async (o) => Oi(await o(n, { parser: "css", __isHTMLStyleAttribute: true }));
}
function vC(e6, t) {
  let { root: r } = e6;
...
function xC(e6) {
  ...
  if (!c.some((d, p) => !d && (p === 0 || c.slice(p + 1).some(Boolean))))
...
function CC(e6, t) {
  ...
  if (n === "v-for")
    return DC;
  if (n === "generic" && Ph(r.parent, t))
    return bC;
  let o = er2(r), i = hc(e6, t);
  if (Yx(r) || Kx(r, t))
    return (l) => wC(o, l, { parseWithTs: i });
  if (n.startsWith("@") || n.startsWith("v-on:"))
    return (l) => EC(o, l, { parseWithTs: i });
  if (n.startsWith(":") || n.startsWith("v-bind:"))
    return (l) => SC(o, l, { parseWithTs: i });
  if (n.startsWith("v-"))
    return (l) => Nh(o, l, { parseWithTs: i });
}
...
function FC(e6) {
  return async (t, r, n, o) => {
    ...
    if (i)
      return i = cc(i, (l) => typeof l == "string" ? je2(false, l, '"', "&quot;") : l), [n.node.rawName, '="', Ae2(i), '"'];
  };
}
function TC(e6) {
...
function gc2(e6, t) {
  if (Vh(!e6.isSelfClosing), qh(e6, t))
    return "";
  switch (e6.type) {
    case "ieConditionalComment":
      return "<!";
    case "element":
      if (e6.hasHtmComponentClosingTag)
        return "<//";
    default:
      return `</${e6.rawName}`;
  }
...
function vc(e6) {
  switch (e6.type) {
    ...
    case "element":
      if (e6.condition)
        return `<!--[if ${e6.condition}]><!--><${e6.rawName}`;
    default:
      return `<${e6.rawName}`;
  }
}
  ...
  return e6.map((i, l) => {
    ...
    if (Je2(u)) {
      if (u.prev && Je2(u.prev)) {
        let w4 = Ci(u.prev, u);
        if (w4)
          return xi(u.prev) ? [J2, J2, pa(i, t, r)] : [w4, pa(i, t, r)];
      }
      return pa(i, t, r);
    }
...
function rE(e6, t, r) {
  let { node: n } = e6;
  if (Rh(n, t))
    return [Mr2(n, t), Ae2(Ju(e6, t, r)), lt2(Wh(n, t)), ...Zu(n, t), Br2(n, t)];
...
function bE(e6, t) {
  e6.walk((r) => {
    ...
    if (n) {
      ...
      for (let o of n)
        o.isLeadingSpaceSensitive = Lx(o, t), o.isTrailingSpaceSensitive = Bx(o, t);
...
function Xi(e6) {
  ...
  let t = e6.indexOf(":", 1);
  if (t === -1)
    throw new Error(`Unsupported format "${e6}" expecting ":namespace:name"`);
...
function WE(e6, t) {
  if (t != null && !(Array.isArray(t) && t.length == 2))
    throw new Error(`Expected '${e6}' to be an array, [start, end].`);
  if (t != null) {
    let r = t[0], n = t[1];
    qE.forEach((o) => {
...
function n2(e6, t, r) {
  ...
  let f = a2((b) => {
    ...
    switch (b.type) {
      case "element":
        f(b);
        for (let D4 of b.attrs)
          f(D4), D4.valueSpan ? (D4.value = D4.valueSpan.toString(), /["']/.test(D4.value[0]) && (D4.value = D4.value.slice(
            1,
            -1
          ))) : D4.value = null;
        break;
    ...
    if (b.type === "element" && (i && (!b.namespace || b.namespace === b.tagDefinition.implicitNamespacePrefix || va2(b)) && (b.name = w4(
      ...
      for (let D4 of b.attrs)
        D4.namespace || (D4.name = w4(D4.name, (x) => Ku.has(b.name) && (Ku.get("*").has(x) || Ku.get(
          b.name
        ).has(x))));
  }, "D"), v = a2((b) => {
...
function SS(e6, t) {
  var r;
  if (e6.type !== "element" || e6.name !== "template")
    return false;
...
var l2 = A(() => {
  PD = Object.defineProperty, gh = a2((e6, t) => {
    for (var r in t)
      PD(e6, r, { get: t[r], enumerable: true });
  }, "Yr"), vh = a2((e6, t, r) => {
    if (!t.has(e6))
...
` && ++u == r)); )
  ...
  RE = (Rn = class {
    ...
    constructor() {
      super(), this._schema = /* @__PURE__ */ new Map(), this._eventSchema = /* @__PURE__ */ new Map(), LE.forEach((t) => {
        ...
        if (d) {
          for (let [p, h] of d)
            r.set(p, h);
          for (let p of this._eventSchema.get(c.toLowerCase()))
            n.add(p);
        }
        l.forEach((p) => {
          if (p.length > 0)
    ...
    hasProperty(t, r, n) {
      if (n.some((o) => o.name === Q5.name))
        return true;
      if (t.indexOf("-") > -1) {
        if (th(t) || rh(t))
          return false;
        if (n.some((o) => o.name === J5.name))
          return true;
      }
...
`);
    ...
    _consumeBlockStart(t) {
      ...
      if (this._cursor.peek() === 40)
        if (this._cursor.advance(), this._consumeBlockParameters(), this._attemptCharCodeUntilFn(De2), this._attemptCharCode(
          41
        ))
    ...
    _tokenizeExpansionForm() {
      ...
      if (tS(this._cursor.peek()) && this._isInExpansionForm())
    ...
    _endToken(t, r) {
      ...
      if (this._currentTokenType === null)
        throw new Gu("Programming error - attempted to end a token which has no token type", null, this._cursor.getSpan(this._currentTokenStart));
    ...
    handleError(t) {
      if (t instanceof xc && (t = this._createError(t.msg, this._cursor.getSpan(t.cursor))), t instanceof Xu)
    ...
    _requireCharCode(t) {
      ...
      if (!this._attemptCharCode(t))
        throw this._createError(wn2(this._cursor.peek()), this._cursor.getSpan(r));
    }
    _attemptStr(t) {
      let r = t.length;
    ...
    _requireCharCodeUntilFn(t, r) {
      ...
      if (this._attemptCharCodeUntilFn(t), this._cursor.diff(n) < r)
        throw this._createError(wn2(this._cursor.peek()), this._cursor.getSpan(n));
    }
    _attemptUntilChar(t) {
    ...
    _consumeEntity(t) {
      ...
      if (this._cursor.advance(), this._attemptCharCode(35)) {
        ...
        let n = this._cursor.clone();
        if (this._attemptCharCodeUntilFn(eS), this._cursor.peek() != 59)
          ...
          let i = Li[o];
          if (!i)
            throw this._createError(ih(o), this._cursor.getSpan(r));
          this._endToken([i, `&${o};`]);
        }
      }
    }
    ...
    _consumePrefixAndName() {
      ...
      for (; this._cursor.peek() !== 58 && !JE(this._cursor.peek()); )
        this._cursor.advance();
      let n;
    ...
    _consumeTagOpen(t) {
      let r, n, o, i = [];
      try {
        if (!Dc(this._cursor.peek()))
          throw this._createError(wn2(this._cursor.peek()), this._cursor.getSpan(t));
    ...
    _consumeAttributeName() {
      ...
      if (t === 39 || t === 34)
        throw this._createError(wn2(t), this._cursor.getSpan());
      this._beginToken(14);
      let r = this._consumePrefixAndName();
    ...
    _consumeTagClose(t) {
      if (this._beginToken(3, t), this._attemptCharCodeUntilFn(De2), this._allowHtmComponentClosingTags && this._attemptCharCode(47))
  ...
  r2 = (Jt2 = class {
    ...
    advanceState(t) {
      if (t.offset >= this.end)
        throw this.state = t, new xc('Unexpected character "EOF"', this);
    ...
    processEscapeSequence() {
      ...
      if (t() === 92)
        if (this.internalState = { ...this.state }, this.advanceState(this.internalState), t() === 110)
          ...
          Yh(this.internalState.peek) ? (this.advanceState(this.internalState), this.state = this.internalState) : this.state.peek = this.internalState.peek;
    }
    decodeHexDigits(t, r) {
      let n = this.input.slice(t.internalState.offset, t.internalState.offset + r), o = parseInt(n, 16);
      if (isNaN(o))
        throw t.state = t.internalState, new xc("Invalid hexadecimal escape sequence", t);
      return o;
    }
    ...
    build() {
      ...
      for (let t of this._containerStack)
        t instanceof bn2 && this.errors.push(Ze2.create(t.name, t.sourceSpan, `Unclosed block "${t.name}"`));
    }
    _advance() {
      let t = this._peek;
    ...
    _parseExpansionCase() {
      ...
      if (this._peek.type !== 22)
        return this.errors.push(Ze2.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null;
      ...
      for (; ; ) {
        if ((this._peek.type === 20 || this._peek.type === 22) && n.push(this._peek.type), this._peek.type === 23)
          if (ph(n, 22)) {
            ...
            return this.errors.push(Ze2.create(null, t.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
        if (this._peek.type === 24)
          if (ph(n, 20))
            n.pop();
          else
...
`) {
      ...
      for (; this._peek.type === 8 || this._peek.type === 5 || this._peek.type === 9; )
        t = this._advance(), r.push(t), t.type === 8 ? o += t.parts.join("").replace(/&([^;]+);/g, dh) : t.type === 9 ? o += t.parts[0] : o += t.parts.join("");
      if (o.length > 0) {
        let i = t.sourceSpan;
    ...
    _consumeEndTag(t) {
      ...
      if (r && this.getTagDefinition(r).isVoid)
        this.errors.push(Ze2.create(r, t.sourceSpan, `Void elements do not have end tags "${t.parts[1]}"`));
    ...
    _popContainer(t, r, n) {
      ...
      for (let i = this._containerStack.length - 1; i >= 0; i--) {
        ...
        if (Ri(l.name) ? l.name === t : (t == null || l.name.toLowerCase() === t.toLowerCase()) && l instanceof r)
    ...
    _getClosestParentElement() {
      for (let t = this._containerStack.length - 1; t > -1; t--)
        if (this._containerStack[t] instanceof Zt2)
  ...
  hS = fS, Si = { attrs: true, children: true, cases: true, expression: true }, hh = /* @__PURE__ */ new Set(["parent"]), mS = (wt2 = class {
    constructor(t = {}) {
      for (let r of /* @__PURE__ */ new Set([...hh, ...Object.keys(t)]))
    ...
    if ((t == null ? void 0 : t(i)) !== false)
      switch (l) {
        ...
        case Qe2: {
          ...
          for (let c = u.length, d = c - 1; d >= 0; --d)
            o.push(u[d]);
          break;
        }
        case Ve2:
...
function sR(e6) {
  ...
  function n(i, l, u) {
    ...
    if (i.type === et2)
      return ((d = u == null ? void 0 : u[l - 1]) == null ? void 0 : d.type) === Ce2 && u[l - 1].hard ? void 0 : "breakParent";
    if (i.type === $t2)
      return "trim";
    if (i.type === Mt2)
    ...
    if (i.type === Qe2)
      return `fill([${i.parts.map((p) => n(p)).join(", ")}])`;
    if (i.type === Pt2)
...
function vR(e6) {
  if (e6.type === ze && e6.break || e6.type === Ce2 && e6.hard || e6.type === et2)
    return true;
}
function bR(e6) {
...
function p2(e6) {
  for (e6 = [...e6]; e6.length >= 2 && fe2(false, e6, -2).type === Ce2 && fe2(false, e6, -1).type === et2; )
    e6.length -= 2;
  if (e6.length > 0) {
...
`, o) : w4;
      ...
      case rr:
        for (let m = w4.length - 1; m >= 0; m--)
          l.push({ ind: f, mode: g6, doc: w4[m] });
        break;
      case Nr2:
        if (p >= 2)
          ...
          case Pe2: {
            ...
            if (!w4.break && Ki(m, l, v, y, r))
              ...
              if (w4.break) {
                ...
                for (let D4 = 1; D4 < w4.expandedStates.length + 1; D4++)
                  if (D4 >= w4.expandedStates.length) {
                    l.push({ ind: f, mode: Pe2, doc: b });
                    break;
                  } else {
              ...
              l.push({ ind: f, mode: Pe2, doc: w4.contents });
            break;
          }
        }
...
function VR(e6, t) {
  let { comments: r } = e6;
  if (delete e6.comments, !zR(r) || !t.printer.canAttachComment)
    return;
  ...
  for (let [g6, w4] of f.entries()) {
    ...
    let S6;
    if (l ? S6 = [w4] : (m.enclosingNode = y, m.precedingNode = v, m.followingNode = b, S6 = [m, D4, x, C, E]), qR(D4, x, f, g6))
      m.placement = "ownLine", d(...S6) || (b ? Qn2(b, m) : v ? eo2(v, m) : $r2(y || C, m));
    else if (WR(D4, x, f, g6))
      m.placement = "endOfLine", p(...S6) || (v ? eo2(v, m) : b ? Qn2(b, m) : $r2(y || C, m));
    else if (m.placement = "remaining", !h(...S6))
      if (v && b) {
        let R = n.length;
        R > 0 && n[R - 1].followingNode !== b && d2(n, x), n.push(w4);
      } else
        v ? eo2(v, m) : b ? Qn2(b, m) : $r2(y || C, m);
  }
  if (d2(n, t), !l)
    for (let g6 of r)
      delete g6.precedingNode, delete g6.enclosingNode, delete g6.followingNode;
}
...
function d2(e6, t) {
  ...
  for (let [d, { comment: p }] of e6.entries())
    d < c ? eo2(i, p) : Qn2(l, p);
  for (let d of [i, l])
    d.comments && d.comments.length > 1 && d.comments.sort((p, h) => t.locStart(p) - t.locStart(h));
  e6.length = 0;
}
function Sc(e6, t, r) {
  let n = r.locStart(t) - 1;
  for (let o = 1; o < e6.length; ++o)
    if (n < r.locStart(e6[o]))
      return o - 1;
  return 0;
}
function UR(e6, t) {
...
function lm({ plugins: e6 = [], showDeprecated: t = false } = {}) {
  ...
  for (let o of rA(Object.assign({}, ...e6.map(({ options: i }) => i), eA)))
    !t && o.deprecated || (Array.isArray(o.choices) && (t || (o.choices = o.choices.filter((i) => !i.deprecated)), o.name === "parser" && (o.choices = [...o.choices, ...tA(o.choices, r, e6)])), o.pluginDefaults = Object.fromEntries(e6.filter((i) => {
      var l;
...
function uA(e6, t) {
  ...
  for (; n > 0 && e6.charCodeAt(~-n) === t.charCodeAt(~-o); )
    n--, o--;
  let i = 0;
  for (; i < n && e6.charCodeAt(i) === t.charCodeAt(i); )
    i++;
  if (n -= i, o -= i, n === 0)
    return o;
  let l, u, c, d, p = 0, h = 0;
  for (; p < n; )
    w2[p] = e6.charCodeAt(i + p), Rc[p] = ++p;
  for (; h < o; )
    for (l = t.charCodeAt(i + h), c = h++, u = h, p = 0; p < n; p++)
      d = l === w2[p] ? c : c + 1, c = Rc[p], u = Rc[p] = c > u ? d > u ? u + 1 : d : d > c ? c + 1 : d;
  return u;
}
function pA(e6, t) {
  let r = new e6(t), n = Object.create(r);
  for (let o of cA)
    o in t && (n[o] = dA(t[o], r, or.prototype[o].length));
  return n;
}
function dA(e6, t, r) {
...
function MA(e6, { isCLI: t, FlagSchema: r }) {
  ...
  for (let o of e6)
    n.push(_A(o, { isCLI: t, optionInfos: e6, FlagSchema: r })), o.alias && t && n.push(fA.create({ name: o.alias, sourceName: o.name }));
  return n;
}
...
async function OA(e6, t = {}) {
  ...
  if (!n.parser)
    if (n.filepath) {
      if (n.parser = iA(n, { physicalFile: n.filepath }), !n.parser)
        throw new f2(`No parser could be inferred for file "${n.filepath}".`);
    } else
      throw new f2("No parser and no file path given, couldn't infer a parser.");
  ...
  for (let [f, g6] of Object.entries(h))
    (n[f] === null || n[f] === void 0) && (n[f] = g6);
...
async function qA(e6, t, r, n, o) {
  ...
  g6();
  let h = e6.stack;
  for (let { print: w4, node: m, pathStack: v } of p)
    try {
      e6.stack = v;
  ...
  function g6() {
    let { node: w4 } = e6;
    if (w4 === null || typeof w4 != "object" || u(e6))
      return;
    for (let v of d(w4))
      Array.isArray(w4[v]) ? e6.each(g6, v) : e6.call(g6, v);
    let m = l(e6, r);
    if (m) {
...
function XA(e6, t) {
  ...
  for (let c of MR(e6, { getVisitorKeys: i, filter: l }))
    u = c;
  return u;
}
function KA(e6, t) {
  ...
  function l(u, c) {
    ...
    let d = {}, p = new Set(o(u));
    for (let f in u)
      !Object.prototype.hasOwnProperty.call(u, f) || i.has(f) || (p.has(f) ? d[f] = l(u[f], u) : d[f] = u[f]);
    let h = r(u, d, c);
    if (h !== null)
      return h ?? d;
  }
...
async function ym(e6, t, r = 0) {
  ...
  if (t.cursorOffset >= 0) {
    let c, d, p, h, f;
    if (t.cursorNode && l.cursorNodeText ? (c = t.locStart(t.cursorNode), d = o.slice(c, t.locEnd(t.cursorNode)), p = t.cursorOffset - c, h = l.cursorNodeStart, f = l.cursorNodeText) : (c = 0, d = o, p = t.cursorOffset, h = 0, f = l.formatted), d === f)
      return {
...
async function xm(e6, t) {
  ...
  if (o.rangeStart >= o.rangeEnd && n !== "" || o.requirePragma && !await I22(n, o))
    return { formatted: e6, cursorOffset: t.cursorOffset, comments: [] };
  let i;
...
function hF(e6, t) {
  ...
  if (e6.charAt(t) === "/" && e6.charAt(t + 1) === "*") {
    for (let r = t + 2; r < e6.length; ++r)
      if (e6.charAt(r) === "*" && e6.charAt(r + 1) === "/")
        return r + 2;
  }
  return t;
}
...
function gF(e6, t) {
  let r = null, n = t;
  for (; n !== r; )
    r = n, n = nr(e6, n), n = Gc(e6, n), n = Xc(e6, n), n = zr(e6, n);
  return n;
}
function vF(e6, t) {
  let r = null, n = t;
  for (; n !== r; )
    r = n, n = em(e6, n), n = Gc(e6, n), n = nr(e6, n);
...
var Fm = A(() => {
  LS = Object.create, tl = Object.defineProperty, BS = Object.getOwnPropertyDescriptor, IS = Object.getOwnPropertyNames, MS = Object.getPrototypeOf, _S = Object.prototype.hasOwnProperty, $S = a2((e6, t) => () => (e6 && (t = e6(e6 = 0)), t), "Eu"), rl = a2((e6, t) => () => (t || e6((t = { exports: {} }).exports, t), t.exports), "Me"), nl = a2((e6, t) => {
    for (var r in t)
      tl(e6, r, { get: t[r], enumerable: true });
  }, "We"), M22 = a2((e6, t, r, n) => {
    if (t && typeof t == "object" || typeof t == "function")
      for (let o of IS(t))
        !_S.call(e6, o) && o !== r && tl(e6, o, { get: a2(
          () => t[o],
          "get"
    ...
    a2(t, "or"), t.prototype = { diff: a2(function(o, i) {
      ...
      if (w4[0].newPos + 1 >= p && m + 1 >= h)
        return d([{ value: this.join(i), count: i.length }]);
      function v() {
        for (var b = -1 * f; b <= f; b += 2) {
          ...
          if (!S6 || R && x.newPos < C.newPos ? (D4 = n(C), c.pushComponent(D4.components, void 0, true)) : (D4 = x, D4.newPos++, c.pushComponent(D4.components, true, void 0)), E = c.extractCommon(D4, i, o, b), D4.newPos + 1 >= p && E + 1 >= h)
            return d(r(c, D4.components, i, o, c.useLongestToken));
          w4[b] = D4;
        }
        f++;
      }
      ...
      for (var c = i.length, d = l.length, p = o.newPos, h = p - u, f = 0; p + 1 < c && h + 1 < d && this.equals(i[p + 1], l[h + 1]); )
        p++, h++, f++;
      ...
      for (var d = 0, p = i.length, h = 0, f = 0; d < p; d++) {
        ...
        if (g6.removed) {
          ...
          if (!g6.added && c) {
            ...
            g6.value = o.join(l.slice(h, h + g6.count));
  ...
  NS = $S(() => {
    ...
    a2(n, "Tn");
    function o(g6, w4) {
      if (!w4 && g6 && g6.__esModule)
        return g6;
      if (g6 === null || typeof g6 != "object" && typeof g6 != "function")
        return { default: g6 };
      var m = n(w4);
      if (m && m.has(g6))
        return m.get(g6);
      ...
      for (var b in g6)
        if (b !== "default" && Object.prototype.hasOwnProperty.call(g6, b)) {
    ...
    function p(g6, w4, m) {
      ...
      if (k6)
        ...
        C === S6 ? C ? T[x] = [C, 0] : T[x] = true : T[x] = [C, S6 - C];
 ...
 `, D4(b.gutter, q.replace(/\d/g, " ")), " ", W, D4(b.marker, "^").repeat(N)].join(""), B6 && m.message && (H4 += " " + D4(b.message, m.message));
          ...
          return ` ${D4(b.gutter, q)}${T.length > 0 ? ` ${T}` : ""}`;
      }).join(`
`);
...
${k6}`), v ? y.reset(k6) : k6;
  ...
  Nc = mR, gR = a2((e6) => {
    if (Array.isArray(e6))
      return e6;
    if (e6.type !== Qe2)
      throw new Error(`Expect doc to be 'array' or '${Qe2}'.`);
    return e6.parts;
  }, "Or");
  a2(ll, "Ne");
  a2(jc, "Je");
  ...
  Vc = kR, TR = (oo2 = class {
    ...
    findAncestor(t) {
      for (let r of Sa2(this, Ra2, Ji).call(this))
        if (t(r))
          return r;
    }
    hasAncestor(t) {
...
in order for it to be formatted.`,
  ...
  iA = aA, to2 = { key: a2((e6) => /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(e6) ? e6 : JSON.stringify(e6), "key"), value(e6) {
    ...
    if (Array.isArray(e6))
      return `[${e6.map((r) => to2.value(r)).join(", ")}]`;
    ...
    _applyNormalization(t, r) {
      ...
      for (let l of o) {
        ...
        let d = a2(({ from: f, to: g6 }) => {
          ...
          if (w4 !== false)
            if (w4 === true)
              this._hasDeprecationWarned(l) || this._utils.logger.warn(this._deprecatedHandler(l, g6, this._utils));
            else
              for (let { value: m } of w4) {
                let v = { key: l, value: m };
        ...
        for (let { from: f, to: g6 } of h.redirect)
          p({ value: f, redirectTo: g6 });
      }
      for (let l of i) {
        let u = t[l];
...
var av = M2((rK, ov) => {
  ...
  function Hl(e6, t) {
    ...
    if (e6 && t && typeof e6 == "object" && typeof t == "object") {
      if (e6.constructor !== t.constructor)
        return false;
      var r, n, o;
      if (Array.isArray(e6)) {
        if (r = e6.length, r != t.length)
          return false;
        for (n = r; n-- !== 0; )
          if (!Hl(e6[n], t[n]))
            return false;
      ...
      if (eB && e6 instanceof Map && t instanceof Map) {
        ...
        for (i = e6.entries(); !(n = i.next()).done; )
          if (!t.has(n.value[0]))
            return false;
        for (i = e6.entries(); !(n = i.next()).done; )
          if (!Hl(n.value[1], t.get(n.value[0])))
            return false;
        return true;
      }
      ...
      if (e6.constructor === RegExp)
        return e6.source === t.source && e6.flags === t.flags;
      if (e6.valueOf !== Object.prototype.valueOf && typeof e6.valueOf == "function" && typeof t.valueOf == "function")
        return e6.valueOf() === t.valueOf();
      if (e6.toString !== Object.prototype.toString && typeof e6.toString == "function" && typeof t.toString == "function")
        return e6.toString() === t.toString();
      if (o = Object.keys(e6), r = o.length, r !== Object.keys(t).length)
        return false;
      for (n = r; n-- !== 0; )
        if (!Object.prototype.hasOwnProperty.call(t, o[n]))
          return false;
      if (QL && e6 instanceof Element)
        return false;
      for (n = r; n-- !== 0; )
...
function fk(e6, { upTo: t }) {
  if (getComputedStyle(e6).visibility === "hidden")
    return true;
  for (; e6; ) {
    if (t !== void 0 && e6 === t)
      return false;
    if (getComputedStyle(e6).display === "none")
      return true;
    e6 = e6.parentElement;
  }
  return false;
...
function fl(e6, t) {
  var r = {};
  for (var n in e6)
    Object.prototype.hasOwnProperty.call(e6, n) && t.indexOf(n) < 0 && (r[n] = e6[n]);
...
//# sourceMappingURL=chunk-YX7Y2EV2.js.map
