...
import {
  ...
  xl,
  z5
} from "./chunk-YX7Y2EV2.js";
import {
  eP,
  sT
} from "./chunk-2KAGV2S3.js";
import {
  P
...
import {
  stringify
} from "./chunk-CVYDVTZ6.js";
import {
  index_modern_default
} from "./chunk-FMVHCJZE.js";
import {
  require_uniq
} from "./chunk-ZWLBDNOR.js";
import {
...
import {
  ...
  rgba
} from "./chunk-IO6BGFFY.js";
import {
  require_pickBy
} from "./chunk-GZYRMQPG.js";
import {
  require_cloneDeep
} from "./chunk-BJUCGKNT.js";
import {
  require_preview_api
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-ONOAI2U6.js");
...
var BooleanControl = ({ name, value: value2, onChange, onBlur, onFocus, argType }) => {
  ...
  if (value2 === void 0)
    return import_react.default.createElement(Fo, { variant: "outline", size: "medium", id: getControlSetterButtonId(name), onClick: onSetFalse, disabled: readonly }, "Set boolean");
...
var ObjectControl = ({ name, value: value2, onChange, argType }) => {
  ...
  if ((0, import_react.useEffect)(() => {
    ...
    return import_react.default.createElement(Fo, { disabled: readonly, id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set object");
...
var TextControl = ({ name, value: value2, onChange, onFocus, onBlur, maxLength, argType }) => {
  ...
  if (value2 === void 0)
    return import_react.default.createElement(Fo, { variant: "outline", size: "medium", disabled: readonly, id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set string");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-KGDBMAHA-UFYCIY7E.js"));
...
var CodeOrSourceMdx = ({ className, children, ...rest }) => {
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return import_react.default.createElement(wu, null, children);
...
var Subheading = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return import_react.default.createElement(Eu, null, children);
...
var Heading2 = ({ children, disableAnchor, ...props }) => {
  if (disableAnchor || typeof children != "string")
    return import_react.default.createElement(Cu, null, children);
...
//# sourceMappingURL=chunk-D2IXIGPW.js.map
